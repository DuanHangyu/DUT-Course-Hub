<template>
  <Card>
    <template #title>
      <img src="@/assets/screen/bjpjxxjd.png" class="w-[183px]" alt="" />
    </template>
    <template #content>
...
import { getClassProgress } from "@/api/highSchool-dataOverview";
  ...
  const option = {
    ...
    yAxis: [
      ...
      },
      {
        ...
        show: true,
        // inverse: true,
        data: data.value?.map((item) => item?.completionRate || 0),
        axisLine: {
          show: false,
        },
        splitLine: {
