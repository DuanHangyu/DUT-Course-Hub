...
var createQtAppInstance2 = (() => {
  ...
  return function (createQtAppInstance2) {
    createQtAppInstance2 = createQtAppInstance2 || {};

    Module2 =
      typeof createQtAppInstance2 != "undefined" ? createQtAppInstance2 : {};
    ...
    if (ENVIRONMENT_IS_NODE) {
      ...
      Module2["inspect"] = function () {
        return "[Emscripten Module2 object]";
      };
    ...
    // 将 stringToUTF8 挂载到 Module2 上
    Module2["stringToUTF8"] = function (str, outPtr, maxBytesToWrite) {
    ...
    var ___wasm_call_ctors = (Module2["___wasm_call_ctors"] = function () {
      return (___wasm_call_ctors = Module2["___wasm_call_ctors"] =
        Module2["asm"]["__wasm_call_ctors"]).apply(null, arguments);
    });
    var _processImage = (Module2["_processImage"] = function () {
      return (_processImage = Module2["_processImage"] =
        Module2["asm"]["processImage"]).apply(null, arguments);
    });
    var _processJson = (Module2["_processJson"] = function () {
      return (_processJson = Module2["_processJson"] =
        Module2["asm"]["processJson"]).apply(null, arguments);
    });
    var _setRefData = (Module2["_setRefData"] = function () {
      return (_setRefData = Module2["_setRefData"] =
        Module2["asm"]["setRefData"]).apply(null, arguments);
    });
    var _setAudioBuffer = (Module2["_setAudioBuffer"] = function () {
      return (_setAudioBuffer = Module2["_setAudioBuffer"] =
        Module2["asm"]["setAudioBuffer"]).apply(null, arguments);
    });
    var _updateBlendShape = (Module2["_updateBlendShape"] = function () {
      return (_updateBlendShape = Module2["_updateBlendShape"] =
        Module2["asm"]["updateBlendShape"]).apply(null, arguments);
    });
    var ___errno_location = (Module2["___errno_location"] = function () {
      return (___errno_location = Module2["___errno_location"] =
        Module2["asm"]["__errno_location"]).apply(null, arguments);
    });
    var _free = (Module2["_free"] = function () {
      return (_free = Module2["_free"] = Module2["asm"]["free"]).apply(
        null,
        arguments
      );
    });
    var _malloc = (Module2["_malloc"] = function () {
      return (_malloc = Module2["_malloc"] = Module2["asm"]["malloc"]).apply(
        null,
        arguments
      );
    });
    var ___getTypeName = (Module2["___getTypeName"] = function () {
      return (___getTypeName = Module2["___getTypeName"] =
        Module2["asm"]["__getTypeName"]).apply(null, arguments);
    });
    var __embind_initialize_bindings = (Module2[
      "__embind_initialize_bindings"
    ] = function () {
      return (__embind_initialize_bindings = Module2[
        "__embind_initialize_bindings"
      ] =
        Module2["asm"]["_embind_initialize_bindings"]).apply(null, arguments);
    });
    var stackSave = (Module2["stackSave"] = function () {
      return (stackSave = Module2["stackSave"] =
        Module2["asm"]["stackSave"]).apply(null, arguments);
    });
    var stackRestore = (Module2["stackRestore"] = function () {
      return (stackRestore = Module2["stackRestore"] =
        Module2["asm"]["stackRestore"]).apply(null, arguments);
    });
    var stackAlloc = (Module2["stackAlloc"] = function () {
      return (stackAlloc = Module2["stackAlloc"] =
        Module2["asm"]["stackAlloc"]).apply(null, arguments);
    });
    var ___cxa_is_pointer_type = (Module2["___cxa_is_pointer_type"] =
      function () {
        return (___cxa_is_pointer_type = Module2["___cxa_is_pointer_type"] =
          Module2["asm"]["__cxa_is_pointer_type"]).apply(null, arguments);
      });
    ...
    return createQtAppInstance2.ready;
  };
})();
if (typeof exports === "object" && typeof module === "object")
  module.exports = createQtAppInstance2;
else if (typeof define === "function" && define["amd"])
  define([], function () {
    return createQtAppInstance2;
  });
else if (typeof exports === "object")
  exports["createQtAppInstance2"] = createQtAppInstance2;
