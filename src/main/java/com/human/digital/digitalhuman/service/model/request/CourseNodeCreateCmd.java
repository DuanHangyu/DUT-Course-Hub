...
/**
 * @Author taoHouChao
 * @Date 22:34 2025/6/11
 */
@Data
@Schema(description = "创建课程节请求")
public class CourseNodeCreateCmd {
    ...
    public CourseNodePO toPo() {
        ...
        courseNodePO.setCourseId(courseId);
        ...
        courseNodePO.setVideoDuration(videoDuration);
