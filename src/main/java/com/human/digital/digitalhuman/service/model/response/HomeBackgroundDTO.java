...
public class HomeBackgroundDTO {
    ...
    public static HomeBackgroundDTO of(HomeBackgroundPO po) {
        return of(po, null);
    }

    public static HomeBackgroundDTO of(HomeBackgroundPO po, Function<String, String> signedUrlFunc) {
        HomeBackgroundDTO dto = new HomeBackgroundDTO();
        dto.setId(po.getId());
